...
class DataStoreRepository @Inject constructor(
    ...
    private object PreferencesKey { val sortBy = stringPreferencesKey(SORT_BY_PREFERENCE_KEY_NAME) }
    ...
    suspend fun saveToDataStore(sortBy: String) {
        datastore.edit { preference -> preference[PreferencesKey.sortBy] = sortBy }
    }
